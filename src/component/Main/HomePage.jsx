...
function HomePage() {
    ...
    return (
        <section id="home" className="relative flex flex-col lg:flex-row items-center justify-between px-6 md:px-16 lg:px-20 pt-[20vh] py-[10vh] bg-[#050505] min-h-screen overflow-hidden">
            <div className="w-full lg:w-[60%] z-10 text-center lg:text-left order-2 lg:order-1 mt-[5vh] lg:mt-0 flex flex-col items-center lg:items-start">
                ...
                <h1 className="text-white text-[clamp(2.5rem,7vw,4.5rem)] font-black mb-6 leading-[1.1] tracking-tighter animate-fade-up delay-2">
                    FULL-STACK WEB <span className="text-transparent bg-clip-text bg-linear-to-r from-yellow-400 via-yellow-200 to-yellow-600">DEVELOPER</span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-8 animate-fade-up delay-3">
                    <div className="flex space-x-4">
                        {socialLinks.map((item, idx) => (
                            <a key={idx} href={item.url} target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-xl flex items-center justify-center text-white transition-all duration-500 hover:-translate-y-2 bg-linear-to-br from-yellow-500/20 via-yellow-300/10 to-yellow-600/20 hover:from-yellow-500/40 hover:via-yellow-300/30 hover:to-yellow-600/40 hover:shadow-lg hover:shadow-yellow-500/20 hover:scale-105 group border border-yellow-500/10">
            ...
            <div className="relative z-10 order-1 lg:order-2">
                <div className="relative w-[48vw] h-[50vw] lg:w-[29vw] lg:h-[33vw] max-w-112.5 max-h-112.5">
                    ...
                    <div className="cursor-pointer w-full h-full bg-[#111] rounded-[30px] overflow-hidden border border-white/10 shadow-2xl relative group">
                        <img src={imgMe} alt="Dashgin Asgarli - Full Stack Web Developer" className="w-full h-full object-cover transition-all duration-700 group-hover:scale-105 group-hover:rotate-2 grayscale-40 group-hover:grayscale-0" />
